...
result(tempshiftid char(20),shiftdate date,timefrom time,timeto time,breakminutes smallint,description char(50),weekenddate date,shiftduration double, referencecode char(20))
// IQXWeb
begin
  select s.tempshiftid,s.shiftdate,s.timefrom,s.timeto,s.breakminutes,
    ...
    getshiftlength(s.timefrom,s.timeto,s.breakminutes) as shiftduration, s.referencecode
